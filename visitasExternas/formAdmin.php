...
if(isset($_REQUEST['IDE'])){
  //print_r(123123);
  $idee=$_POST['IDE'];
  $consulta="SELECT 761363X1X2, 761363X1X1APP, 761363X1X1APM, 761363X1X1NOM FROM survey_761363 WHERE id = '$idee'";
...
<section class="form-register">
  ...
  <form action="registroAdmin.php" method="POST">
    ...
    <tr>
      ...
      <td><input class="controls" name="CI" type="text"  size="30" value="<?php echo intval($row[0]) ?>" /></td>
    </tr>
    <tr>
      <td><strong>Apellido Paterno</strong></td>
      <td><input class="controls" name="app" type="text"  size="30" value="<?php echo $row[1] ?>"/></td>
      
    </tr>
    <tr>
      <td><strong>Apellido Materno:</strong></td>
      <td><input class="controls" name="apm" type="text"  size="30" value ="<?php echo $row[2] ?>" required/></td>

    </tr>
    <tr>
      <td><strong>Nombre:</strong></td>
      <td><input class="controls" name="nom" type="text"  size="30" value ="<?php echo $row[3] ?>" required/></td>    
    </tr>
    ...
    <tr>
      ...
      <td><select id="slct2" name="slct2" onchange="populated(id,'slct3')"></select></td>
    </tr>
    <tr>
      <?php ?>
      <td><strong>Personal:</strong></td>
      <td> <select id="slct3" name="slct3" >
      <option>Select..</option>
      </select>
