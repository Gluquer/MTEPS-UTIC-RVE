...
<?php
  ...
  if (!isset($_SESSION['user_id'])) {
    header('Location: '.$var_dir.'/login.php');
  }

  $codigo = $_SESSION['user_id'];
  ...
  $userDB = mysqli_query($conn, "SELECT tid, firstname, lastname, email, token FROM tokens_761363 WHERE token = '$codigo'");
?>
              ...
              <div class="card-body cleartfix">
                <div class="media align-items-center">
                  <div class="media-body">
                    <p id="nombres-email" class="text-bold"><?php echo $user[1] ?></p>
                    <p id="correo-email" class="text-bold"><?php echo $user[2] ?></p>
                  </div>
                  <div class="align-self-center">
                  <a href="<?php echo ($var_dir.'/logout.php') ?>" class="btn btn-outline-danger">Salir</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="container">
              <div class="col-md-5 pl-0">
                <div class="input-group">
                  <input type="text" class="form-control" placeholder="Ingrese termino de busqueda"
                    aria-describedby="basic-addon2" id="termino-busqueda">
                  <div class="input-group-append">
                    <button class="btn btn-outline-primary" type="button" onclick="busqueda()">
              ...
              <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav">
                  <a href="<?php echo ($var_dir_lime.'/index.php/761363') ?>" class="btn btn-outline-primary"
                    target="__blank">Nuevo registro</a>
                </ul>
              </div>
                  ...
                  <tr>
                    ...
                    <form action='ingresarfecha.php' method="POST" accept-charset="utf-8">
                      ...
                      <?php if($registro['HORASALIDA']==NULL){
                        ?>
                        <button class="btn btn-circle btn-outline-primary mr-2" name="ide" value="<?= $registro['ide'] ?>" 
              ...
              <tbody>
                <?php foreach ($query2 as $registro2) { ?>
                  <tr>
                    ...
                    <td>
                    <form action='formactual.php' method="POST" accept-charset="utf-8">  
                    <button class="btn btn-info" name="ide" value="<?= $registro2['ide']?>" type="submit" href="./formactual.php"> 
                   Actualizar
                        </buttom>
                     </form> 
                    </td>
